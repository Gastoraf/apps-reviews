 ...
 * 
 */
@WebFault(name = "UserAlreadyExistsException", targetNamespace = "http://service.service.authorization.lab.ru/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: ru.lab.authorization.client.UserAlreadyExistsException
     */
